...
const bookingLabels: Record<string, string> = { paid_pending: "Awaiting admin decision", approved: "Approved · capacity reserved", rejected: "Rejected", cancelled: "Cancelled" };
