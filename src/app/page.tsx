...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <footer className="footer"><span>© 2026 Pixlwave</span><span>English · INR · IST · Kerala launch</span><span>Published discovery is live; payment confirmation remains admin-coordinated</span></footer>
    </main>
  );
}
