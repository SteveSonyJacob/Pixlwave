...
export const serverEnvSchema = z.object({
  ...
  MAPS_PRIMARY_PROVIDER: z.literal("openstreetmap"),
  OSM_NOMINATIM_URL: z.url().optional(),
  NEXT_PUBLIC_OSM_TILE_URL: z.url().optional(),
  MAPS_CONTACT_EMAIL: z.email().optional(),
